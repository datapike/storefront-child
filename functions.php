...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		...
		<div class="site-info">
			...
			<br /> <?php printf( esc_attr__( '%1$s designed by %2$s.', 'storefront' ), 'Website', '<a href="http://copyquality.com" title="Quality Business Solutions - Your Total Office Source" rel="author">Quality Business Solutions</a>' ); ?>
			<?php } ?>
		</div><!-- .site-info -->
		<?php
	}
